...
A new interface can be created by authorized clients via [an API call](https://developer.broadcom.com/xapis/provider-infrastructure-apis/latest/cloudapi/1.0.0/interfaces/post/). For example:
...
An interface can be updated by authorized clients via [an API call](https://developer.broadcom.com/xapis/provider-infrastructure-apis/latest/cloudapi/1.0.0/interfaces/id/put/). For example:
...
Behaviors can also be added to the interface [individually](https://developer.broadcom.com/xapis/provider-infrastructure-apis/latest/cloudapi/1.0.0/interfaces/id/behaviors/post/) or [as a set](https://developer.broadcom.com/xapis/provider-infrastructure-apis/latest/cloudapi/1.0.0/interfaces/id/behaviors/put/).
...
An interface can be updated by authorized clients via [an API call](https://developer.broadcom.com/xapis/provider-infrastructure-apis/latest/cloudapi/1.0.0/interfaces/id/delete/).
...
VMware Cloud Foundation Automation provides pre-defined interfaces for common use cases.
