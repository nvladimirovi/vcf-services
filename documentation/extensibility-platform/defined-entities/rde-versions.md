...
```text
GET
https://{{vcfa_host}}:{{vcfa_port}}/cloudapi/1.0.0/entities/urn:vcloud:entity:vmware:tkgcluster:56bacbaa-8ddc-4bef-b7a5-e8f6758aff25
```
...
```text
GET
https://{{vcfa_host}}:{{vcfa_port}}/cloudapi/1.0.0/entities/types/vmware/tkgcluster/1
```
...
downgraded to another version using the [RDE Version Migration API](https://developer.broadcom.com/xapis/provider-infrastructure-apis/latest/cloudapi/1.0.0/entityTypes/typeId/migrateEntities/post/).
...
The RDE migration API supports migrating entities in batches. The system handles larger migrations automatically by processing entities in manageable chunks.

This improvement ensures:
- Reliable migration of large entity sets
- Better progress tracking
- Reduced memory consumption during migration
...
```text
GET
https://{{vcfa_host}}:{{vcfa_port}}/cloudapi/1.0.0/entities/urn:vcloud:entity:vmware:tkgcluster:56bacbaa-8ddc-4bef-b7a5-e8f6758aff25?acceptType=urn:vcloud:type:vmware:tkgcluster:1.1.0
```
...
Controls API](https://developer.broadcom.com/xapis/provider-infrastructure-apis/latest/type-access-controls/).
